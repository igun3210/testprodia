                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <div class="main-header-center ms-3 d-none d-lg-block">
                            <input class="form-control" placeholder="Search for results<?= base_url(); ?>." type="search">
                            ...
                            <div class="dropdown d-none">
                                ...
                                <div class="dropdown-menu header-search dropdown-menu-start">
                                    <div class="input-group w-100 p-2">
                                        <input type="text" class="form-control" placeholder="Search<?= base_url(); ?><?= base_url(); ?>">
                                                ...
                                                <div class="message-menu">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="<?= base_url(); ?>/assets/images/users/1.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                            ...
                                                            <span>Commented on file Guest list<?= base_url(); ?><?= base_url(); ?></span>
                                                        </div>
                                                    </a>
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                        ...
                                                        <div class="wd-90p">
                                                            ...
                                                            <span>New Meetup Started<?= base_url(); ?><?= base_url(); ?><?= base_url(); ?></span>
                                                        </div>
                                                    </a>
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                        ...
                                                        <div class="wd-90p">
                                                            ...
                                                            <span>Brizid is in the Warehouse<?= base_url(); ?>.</span>
                                                        </div>
                                                    </a>
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                        ...
                                                        <div class="wd-90p">
                                                            ...
                                                            <span>New Product Realease<?= base_url(); ?><?= base_url(); ?><?= base_url(); ?></span>
                                                        </div>
                                                    </a>
                                        ...
                                        <div class="browser-stats">
                                            <div class="row mb-4">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/chrome.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/opera.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/ie.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/firefox.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/edge.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/safari.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                                    <img src="<?= base_url(); ?>/assets/images/browsers/netscape.svg" class="img-fluid"
                                                        alt="img">
                                                </div>
                                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <a href="chat.html">
                                            ...
                                            <p class="mb-0 fs-12 text-muted"> Hey! there I' am available<?= base_url(); ?><?= base_url(); ?> </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <a href="chat.html">
                                            ...
                                            <p class="mb-0 fs-12 text-muted"> Okay<?= base_url(); ?>.I will be waiting for you </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <a href="chat.html">
                                            ...
                                            <p class="mb-0 fs-12 text-muted"> Hi we can explain our new project<?= base_url(); ?><?= base_url(); ?><?= base_url(); ?>
                                            </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <a href="chat.html">
                                            ...
                                            <p class="mb-0 fs-12 text-muted"> New product Launching<?= base_url(); ?>. </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <a href="chat.html">
                                            ...
                                            <p class="mb-0 fs-12 text-muted">Schedule Realease<?= base_url(); ?><?= base_url(); ?><?= base_url(); ?> </p>
                                        </a>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
                                ...
                                <div class="list-group-item d-flex align-items-center">
                                    ...
                                    <div class="">
                                        <a href="chat.html">
                                            <div class="fw-semibold text-dark" data-bs-toggle="modal"
                                                data-target="#chatmodel">Addie Minstra</div>
                                            <p class="mb-0 fs-12 text-muted">Contact me for details<?= base_url(); ?><?= base_url(); ?></p>
                                        </a>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center">
